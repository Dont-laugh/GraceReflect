...
namespace DontLaugh
{
    public class InstanceFunctionInvoker<TTarget, TParam0, TParam1, TParam2, TParam3, TResult>
        : BaseInstanceFunctionInvoker<TTarget, TResult>
    {
        private Func<TTarget, TParam0, TParam1, TParam2, TParam3, TResult> _invoke;
        ...
        protected override void CompileEmit()
        {
            ...
            _invoke = (Func<TTarget, TParam0, TParam1, TParam2, TParam3, TResult>) method.CreateDelegate(
                typeof(Func<TTarget, TParam0, TParam1, TParam2, TParam3, TResult>));
        }

        protected override void CreateDelegate()
        {
            _invoke = (Func<TTarget, TParam0, TParam1, TParam2, TParam3, TResult>) _methodInfo.CreateDelegate(
                typeof(Func<TTarget, TParam0, TParam1, TParam2, TParam3, TResult>));
        }

        public override TResult Invoke(object arg0, object arg1, object arg2, object arg3)
        {
            return _invoke(_target, (TParam0) arg0, (TParam1) arg1, (TParam2) arg2, (TParam3) arg3);
        }
    }
}
